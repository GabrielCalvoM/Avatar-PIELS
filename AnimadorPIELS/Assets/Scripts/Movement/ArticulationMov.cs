...
public abstract class ArticulationMov : MonoBehaviour
{
    ...
    public static event Action OnBeginRotation;
    public static event Action<string, Quaternion> OnEndRotation;
    ...
    public void OnPointerDown()
    {
        ...
        if (cameraRef == null)
        {
            ...
            OnEndRotation?.Invoke(transform.name, transform.localRotation);
            return;
        }
